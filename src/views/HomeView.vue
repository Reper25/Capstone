<template>
  <div class="body">
    ...
    <br>
    <h2 class="hdr text-left mx-2" >Bring On The Fashion</h2>
    <br>
    <div class="portfolio">
...
<br>
<h2 class="hdr text-end mx-2">Endless Fashion</h2>
  <br>
  </div>
</template>
...
<style scoped>
@import url('https://fonts.cdnfonts.com/css/oblivious-font');
.body{
